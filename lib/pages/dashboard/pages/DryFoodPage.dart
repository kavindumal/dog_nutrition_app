...
class DryFoodPage extends StatefulWidget {
  const DryFoodPage({super.key});

  @override
  _DryFoodPageState createState() => _DryFoodPageState();
}

class _DryFoodPageState extends State<DryFoodPage> {
  ...
  Future<void> _fetchProducts() async {
    try {
      QuerySnapshot snapshot = await FirebaseFirestore.instance
          .collection('products')
          .where('type', isEqualTo: 'Dry') // Filter products where type is 'Dry'
          .get();
