...
class Wetfoodpage extends StatefulWidget {
  const Wetfoodpage({super.key});

  @override
  _WetFoodPageState createState() => _WetFoodPageState();
}

class _WetFoodPageState extends State<Wetfoodpage> {
  ...
  Future<void> _fetchProducts() async {
    try {
      QuerySnapshot snapshot = await FirebaseFirestore.instance
          .collection('products')
          .where('type', isEqualTo: 'Wet') // Filter products where type is 'Dry'
          .get();
